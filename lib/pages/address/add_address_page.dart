...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition =
      const CameraPosition(target: LatLng(51.1030107, 17.0339951), zoom: 23);
  late LatLng _initialPosition = LatLng(51.1030107, 17.0339951);
        ...
        child: GetBuilder<UserController>(builder: (userController) {
          ...
          return GetBuilder<LocationController>(builder: (locationController) {
            if (locationController.placemark.name != null &&
                locationController.placemark.name!.isNotEmpty) {
              _addressController.text =
                  ...
                  GestureDetector(
                    onTap: () {
                      AddressModel addressModel = AddressModel(
                          ...
                          contactPersonNumder: _contactPersonNumber.text,
